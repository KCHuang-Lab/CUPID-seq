...
* [Using Singularity/Apptainer](https://github.com/KCHuang-Lab/CUPID-seq/blob/main/README.md#using-singularityapptainer)
* [Inputs](https://github.com/KCHuang-Lab/CUPID-seq/blob/main/README.md#inputs)
* [Building Images](https://github.com/KCHuang-Lab/CUPID-seq/blob/main/README.md#building-images)
* [Building with Docker](https://github.com/KCHuang-Lab/CUPID-seq/blob/main/README.md#building-with-docker)
* [Building with Singularity/Apptainer](https://github.com/KCHuang-Lab/CUPID-seq/blob/main/README.md#building-with-singularityapptainer)
...
3. **Run the test analysis**
 ...
 <img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/testSuccessOutputs.png?raw=true" alt="Alt Text" width="400" height="1000">\
...
<img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/snakemakeSuccessOutput.png?raw=true" alt="Alt Text" width="750" height="400">\
\
...
The script for initiating the Snakemake run using Slurm (submitSnakemake.sh) and the Snakefile encoding the analysis are found in the top 16s-demux file.\
  <img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/16s-demux_fileStructure.png?raw=true" alt="Alt Text" width="400" height="400">
...
\
<img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/docker_demux_fileStructure.png?raw=true" alt="Alt Text" width="400" height="400">\
\
...
\
 <img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/docker_buildSuccessOutput.png?raw=true" alt="Alt Text" width="400" height="400">\
\
...
\
 <img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/sing_demux_fileStructure.png?raw=true" alt="Alt Text" width="400" height="400">\
\
...
<img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/buildSuccessOutput.png?raw=true" alt="Alt Text" width="750" height="400">\
\
...
As a reminder, the final structure of reads after the library prep will look something like this (lengths not to scale):\
  <img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/primerStructureImage.png?raw=true" alt="Alt Text" width="400" height="400">\
...
| 7 | GCAAGTC  | |
 ...
 <img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/phasedPrimerImage.png?raw=true" alt="Alt Text" width="400" height="400">
...
Within ‘workflow’, there should be a ‘test_out’ directory, containing ‘demux’ and ‘trimmed’ directories. Under ‘demux’, there should be four sets of 3 files; each should have 1 * .extract.log file, and 2 .fastq.gz files. There should also be two directories: ‘R1’ and ‘R2’. The contents of ‘R1’ and ‘R2’ should have the same filenames (but correspond to forward and reverse reads for the specified sample). For each sample in the above, there should be 8 files, ending with ‘-L * .fastq.gz’, where * is an integer from 0 to 7:
 ...
 <img src="https://github.com/KCHuang-Lab/CUPID-seq/blob/main/images/TestSuccessOutputs_1.png?raw=true" alt="Alt Text" height="600">
